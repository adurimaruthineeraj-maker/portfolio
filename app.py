...
# Portfolio data - Maruthi Neeraj Aduri's Projects
PORTFOLIO_ITEMS = [
    {
        'id': 1,
        'title': 'Hotel Reservation and Cancellation Prediction',
        'description': 'This project uses machine learning algorithms to predict hotel booking cancellations before check-in. Key features such as lead time, deposit type, and customer behavior were analyzed. Models including Logistic Regression, Decision Tree, and Random Forest were used to improve operational efficiency and reduce revenue loss.',
        'image': 'project1.jpg',
        'technologies': ['Python', 'Machine Learning', 'Logistic Regression', 'Decision Tree', 'Random Forest', 'Data Analysis'],
        'keyFeatures': [
            'Prediction of hotel booking cancellations',
            'Analysis of customer behavior and booking features',
...
def contact():
    ...
    my_details = {
        'name': 'Maruthi Neeraj Aduri',
        'email': 'adurimaruthineeraj@gmail.com',
        'phone': '+91-9381791109'
    }
    return render_template('contact.html', my_details=my_details)
